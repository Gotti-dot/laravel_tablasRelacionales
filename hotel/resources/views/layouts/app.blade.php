        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route('huespedes.index') }}">Huéspedes</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark">
                            <li><a class="dropdown-item" href="{{ route('huespedes.reporte') }}">Huéspedes</a></li>
                            <li><a class="dropdown-item" href="{{ route('habitaciones.reporte') }}">Habitaciones</a></li>
                            <li><a class="dropdown-item" href="{{ route('reservas.reporte') }}">Reservas</a></li>
                        </ul>
                    </li>
                </ul>
