                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark">
                            <li><a class="dropdown-item" href="{{ route('socios.reporte') }}">Socios</a></li>
                            <li><a class="dropdown-item" href="{{ route('libros.reporte') }}">Libros</a></li>
                            <li><a class="dropdown-item" href="{{ route('prestamos.reporte') }}">Préstamos</a></li>
                        </ul>
                    </li>
                </ul>
