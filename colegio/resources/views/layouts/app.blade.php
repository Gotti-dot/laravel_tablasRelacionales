...
<head>
    ...
    <title>Inscripciones Colegio</title>
</head>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark">
                            ...
                            <li><a class="dropdown-item" href="{{ route('cursos.reporte') }}">Cursos</a></li>
                            <li><a class="dropdown-item" href="{{ route('inscripciones.reporte') }}">Inscripciones</a></li>
                        </ul>
                    </li>
                </ul>
